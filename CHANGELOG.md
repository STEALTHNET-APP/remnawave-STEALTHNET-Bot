...
### Лендинг и конструктор

- Новый объёмный дизайн лендинга, адаптация для телефонов и исправления фона и логотипа.
- Визуальный конструктор с настройкой блоков, содержимого, оформления и предпросмотром; тарифы и покупка связаны с панелью.

### Клиентский кабинет и Аврора

- Тарифы сгруппированы по категориям. Карточки показывают срок, стоимость, трафик и число устройств; выбранный вариант передаётся в оформление покупки.
- Полный экран Telegram используется только Авророй. Добавлены светлая и тёмная темы, зелёный акцент тёмной Авроры, клиентские разделы и настройки.
- Исправлены повторное предложение создать уже установленный пароль и увеличение интерфейса при фокусе на полях на iPhone.
- Улучшены поля форм в светлой теме и компоновка классического кабинета.
- Для ПК окно оплаты стало широким: условия и промокод слева, способы оплаты справа. Заголовок и закрытие остаются на экране, длинное содержимое прокручивается внутри.

### Подписки и платежи

- Выдача тарифа администратором учитывает режим одной подписки или мультиподписки. В режиме одной подписки существующая подписка, включая триал, обновляется вместо создания второй.
- Добавлен ParityPay: настройки магазина в админке, оплата тарифов и пополнение баланса в кабинете и боте, проверка уведомлений и защита от повторного зачисления.
- В боте исправлено отображение RollyPay для пополнения баланса.
- Номер версии 6.2.0 согласован в панели, API и метаданных пакетов.
